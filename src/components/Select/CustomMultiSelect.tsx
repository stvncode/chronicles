...
import { Box, CloseButton, Flex, MultiSelect, type MultiSelectValueProps, rem, type SelectItemProps } from '@mantine/core'
...
const Item = forwardRef<HTMLDivElement, SelectItemProps & { icon: ReactNode }>(({ label, icon, ...others }, ref) => (
    <div ref={ref} {...others}>
        <Flex align="center">
            <Box mr={10}>{icon}</Box>
            <div>{label}</div>
