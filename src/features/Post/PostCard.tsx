...
export const PostCard: FC<PostCardProps> = ({ id, timeReading, title, technos, image, authorId, link, description, createdAt }) => {
    ...
    return (
        <a href={link} target="_blank" style={{ textDecoration: 'none' }}>
            <Card shadow='lg' radius="md" padding="lg" withBorder className={classes.card}>
                <PostOptions id={id} />
                    ...
                    <Flex direction="column" gap={30}>
                        <Flex align="center" gap={20}>
                            ...
                            <Text className={classes.date}>
                                {createdAt.toLocaleDateString('fr-FR', { day: 'numeric', month: 'long' })}
                            </Text>
                        </Flex>
